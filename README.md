...
text-decoration: underline; - подчёркивание и другие эффекты для текста</br>
text-transform: uppercase; - приводит все буквы в верхний регистр</br>
...
#### 1.3 У этого задания есть небольшое ТЗ: 
  ...
  2) Создайте `Заголок первого уровня` и дайте ему class `title`. В CSS файле создайте селектор для класса title,  и напишите следующие стили - размер шрифта 40px, цвет текста #f03333, межстрочный отступ 1.2, все буквы заглавные
